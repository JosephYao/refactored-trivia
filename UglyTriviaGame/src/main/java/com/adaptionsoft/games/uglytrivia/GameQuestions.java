...
public class GameQuestions {
	...
	public void askQuestion(int currentPlayerPlace) {
		if (currentCategory(currentPlayerPlace).equals("Pop"))
			System.out.println(popQuestions.removeFirst());
		if (currentCategory(currentPlayerPlace).equals("Science"))
			System.out.println(scienceQuestions.removeFirst());
		if (currentCategory(currentPlayerPlace).equals("Sports"))
			System.out.println(sportsQuestions.removeFirst());
		if (currentCategory(currentPlayerPlace).equals("Rock"))
